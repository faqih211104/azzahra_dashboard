                ...
                <tr>
                    ...
                    <td class="text-center border-b">
                        <div class="flex items-center justify-center">
                            <button onclick="sendFollowUp('<?= $row['cos_hp'] ?>', '<?= $row['cos_nama'] ?>', '<?= $row['trans_kode'] ?>')" class="w-8 h-8 flex items-center justify-center rounded-full bg-green-500 text-white hover:bg-green-600" title="Kirim Follow Up">
