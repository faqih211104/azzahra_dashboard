				    					...
				    					<div class="flex items-center justify-center">
				    						...
				    						<div class="flex-1 text-left mr-3">
				    							<div class="font-medium text-sm">
				    								<i data-feather="watch" class="w-4 h-4 inline mr-1"></i>
				    								<?= $row['cos_tipe'] . ' ' . $row['cos_model'] ?>
				    							</div>
				    						...
				    						<div class="dropdown relative">
				    							<button class="button px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded" onclick="toggleDropdown(this)">
				    								<i data-feather="more-vertical" class="w-4 h-4"></i>
				    							</button>
				    							<div class="dropdown-menu absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50 hidden">
				    								<a href="<?= site_url('Service/print_tts/'.$row['cos_kode'])?>" target="_blank" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
				    									<i data-feather="printer" class="w-4 h-4 mr-2"></i> Print TTS
				    								</a>
				    							</div>
				    						</div>
				    					</div>
	           ...
	           .then(data => {
	               if (data.status === 'success') {
	                   ...
	                   Swal.fire({
	                       ...
	                       window.location.href = '<?= site_url('Service/cos_proses') ?>';
	                   });
	               } else {
	                   Swal.fire({
	                       icon: 'error',
